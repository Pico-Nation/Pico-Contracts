...
## picoio::regproducer producer producer_key url location
...
## picoio::voteproducer voter proxy producers
...
## picoio::regproxy proxy is_proxy
...
## picoio::delegatebw from receiver stake\_net\_quantity stake\_cpu\_quantity transfer
...
## picoio::undelegatebw from receiver unstake\_net\_quantity unstake\_cpu\_quantity
...
## picoio::onblock header
   - This special action is triggered when a block is applied by a given producer, and cannot be generated from
     any other source. It is used incpicoent the number of unpaid blocks by a producer and update producer schedule.

## picoio::claimrewards producer
   - **producer** producer account claiming per-block and per-vote rewards
   
## picoio::deposit owner amount
...
## picoio::unstaketorex owner receiver from\_net from\_cpu
...
## picoio::rentcpu from receiver loan\_payment loan\_fund
   ...
   - At expiration, if balance is greater than or equal to `loan_payment`, `loan_payment` is taken out of loan balance and used to renew the loan. Otherwise, the loan is closed and user is refunded any picoaining balance.
   
## picoio::rentnet from receiver loan\_payment loan\_fund
...
## picoio::fundcpuloan from loan\_num payment
