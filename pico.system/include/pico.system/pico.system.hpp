...
namespace picoiosystem {
   ...
   using picoio::microseconds;
   using picoio::name;
   using picoio::same_payer;
   using picoio::symbol;
   using picoio::symbol_code;
   using picoio::time_point;
   using picoio::time_point_sec;
   using picoio::unsigned_int;
   ...
   /**
    *
    * @defgroup picoiosystem pico.system
    * @ingroup picoiocontracts
    * pico.system contract defines the structures and actions needed for blockchain's core functionality.
    * - Users can stake tokens for CPU and Network bandwidth, and then vote for producers or
    *    delegate their vote to a proxy.
    * - Producers register in order to be voted for, and can claim per-block and per-vote rewards.
    * - Users can buy and sell RAM at a market-determined price.
    * - Users can bid on ppicoium names.
    ...
    */
   struct [[picoio::table, picoio::contract("pico.system")]] name_bid {
     name            newname;
     name            high_bidder;
    ...
    */
   struct [[picoio::table, picoio::contract("pico.system")]] bid_refund {
      name         bidder;
      asset        amount;
    ...
    */
   typedef picoio::multi_index< "namebids"_n, name_bid,
    ...
    */
   typedef picoio::multi_index< "bidrefunds"_n, bid_refund > bid_refund_table;
    ...
    */
   struct [[picoio::table("global2"), picoio::contract("pico.system")]] picoio_global_state2 {
      picoio_global_state2(){}
      ...
      PICOLIB_SERIALIZE( picoio_global_state2, (new_ram_per_block)(last_ram_increase)(last_block_num)
    ...
    */
   struct [[picoio::table("global3"), picoio::contract("pico.system")]] picoio_global_state3 {
      picoio_global_state3() { }
      time_point        last_vpay_state_update;
      double            total_vpay_share_change_rate = 0;

      PICOLIB_SERIALIZE( picoio_global_state3, (last_vpay_state_update)(total_vpay_share_change_rate) )
   };

   /**
    * Defines new global state parameters to store inflation rate and distribution
    */
   struct [[picoio::table("global4"), picoio::contract("pico.system")]] picoio_global_state4 {
      picoio_global_state4() { }
      double   continuous_rate;
      int64_t  inflation_pay_factor;
      int64_t  votepay_factor;

      PICOLIB_SERIALIZE( picoio_global_state4, (continuous_rate)(inflation_pay_factor)(votepay_factor) )
   };

   /**
    * Defines new global state parameters to store picome specific parameters
    */
   struct [[picoio::table("globalpico"), picoio::contract("pico.system")]] picoio_global_pico_state {
      double  per_stake_share = 0.6;
      double  per_vote_share  = 0.3;

      name gifter_attr_contract = name{"pico.attr"};
      name gifter_attr_issuer   = name{"pico.attr"};
      name gifter_attr_name     = name{"accgifter"};

      int64_t guardian_stake_threshold = 250'000'0000LL;
      microseconds producer_max_inactivity_time = picoio::minutes(30);
      microseconds producer_inactivity_punishment_period = picoio::days(30);

      microseconds stake_lock_period   = picoio::days(180);
      microseconds stake_unlock_period = picoio::days(180);

      microseconds reassertion_period = picoio::days( 30 );

      PICOLIB_SERIALIZE( picoio_global_pico_state, (per_stake_share)(per_vote_share)
    ...
    */
   struct [[picoio::table("rotations"), picoio::contract("pico.system")]] rotation_state {
      time_point   last_rotation_time;
      microseconds rotation_period;
      uint32_t     standby_prods_to_rotate;

      std::vector<picoio::producer_authority> standby_rotation;

      PICOLIB_SERIALIZE( rotation_state, (last_rotation_time)(rotation_period)(standby_prods_to_rotate)(standby_rotation) )
   };

   /**
    * Global state singleton added in version 1.0
    */
   typedef picoio::singleton< "rotations"_n, rotation_state >   rotation_state_singleton;

   /**
    * Defines `producer_info` structure to be stored in `producer_info` table, added after version 1.0
    */
   struct [[picoio::table, picoio::contract("pico.system")]] producer_info {
      name                  owner;
      double                total_votes = 0;
      picoio::public_key     producer_key; /// a packed public key object
      bool                  is_active = true;
      std::string           url;
      ...
      uint16_t              location = 0;
      picoio::binary_extension<picoio::block_signing_authority>  producer_authority;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      PICOLIB_SERIALIZE( producer_info, (owner)(total_votes)(producer_key)(is_active)(url)
    ...
    */
   struct [[picoio::table, picoio::contract("pico.system")]] producer_info2 {
      name            owner;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      PICOLIB_SERIALIZE( producer_info2, (owner)(votepay_share)(last_votepay_share_update) )
   };
    ...
    */
   struct [[picoio::table, picoio::contract("pico.system")]] voter_info {
   public:
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      PICOLIB_SERIALIZE( voter_info, (owner)(proxy)(producers)(staked)(locked_stake)(last_vote_weight)
   ...
   struct [[picoio::table, picoio::contract("pico.system")]] user_resources {
      name          owner;
      asset         net_weight;
      asset         cpu_weight;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      PICOLIB_SERIALIZE( user_resources, (owner)(net_weight)(cpu_weight)(own_stake_amount)(free_stake_amount) )
   };

   /**
    *  Every user 'from' has a scope/table that uses every receipient 'to' as the primary key.
    */
   struct [[picoio::table, picoio::contract("pico.system")]] delegated_bandwidth {
      name          from;
      name          to;
      asset         net_weight;
      asset         cpu_weight;
      ...
      // explicit serialization macro is not necessary, used here only to improve compilation time
      PICOLIB_SERIALIZE( delegated_bandwidth, (from)(to)(net_weight)(cpu_weight))
    ...
    */
   typedef picoio::multi_index< "delband"_n, delegated_bandwidth > del_bandwidth_table;

   /**
    *  These table is designed to be constructed in the scope of the relevant user, this
    *  facilitates simpler API for per-user queries
    */
   typedef picoio::multi_index< "userres"_n, user_resources >      user_resources_table;
    ...
    */
   typedef picoio::multi_index< "voters"_n, voter_info,
    ...
    */
   typedef picoio::multi_index< "producers"_n, producer_info,
                               indexed_by<"prototalvote"_n, const_mem_fun<producer_info, double, &producer_info::by_votes>  >
                             > producers_table;
   /**
    * Defines new producer info table added in version 1.3.0
    */
   typedef picoio::multi_index< "producers2"_n, producer_info2 > producers_table2;
    ...
    */
   typedef picoio::singleton< "global2"_n, picoio_global_state2 > global_state2_singleton;
   /**
    * Global state singleton added in version 1.3
    */
   typedef picoio::singleton< "global3"_n, picoio_global_state3 > global_state3_singleton;
   /**
    * Global state singleton added in version 1.6.x
    */
   typedef picoio::singleton< "global4"_n, picoio_global_state4 > global_state4_singleton;

   typedef picoio::singleton< "globalpico"_n, picoio_global_pico_state > global_pico_state_singleton;
    ...
    * - `loan_num` incpicoents with each new loan.
    */
   struct [[picoio::table,picoio::contract("pico.system")]] rex_pool {
      uint8_t    version = 0;
      asset      total_lent;
      asset      total_unlent;
      asset      total_rent;
    ...
    */
   typedef picoio::multi_index< "rexpool"_n, rex_pool > rex_pool_table;
    ...
    */
   struct [[picoio::table,picoio::contract("pico.system")]] rex_fund {
      uint8_t version = 0;
      name    owner;
      asset   balance;
    ...
    */
   typedef picoio::multi_index< "rexfund"_n, rex_fund > rex_fund_table;
    ...
    */
   struct [[picoio::table,picoio::contract("pico.system")]] rex_balance {
      uint8_t version = 0;
      name    owner;
      asset   vote_stake;
      asset   rex_balance;
    ...
    */
   typedef picoio::multi_index< "rexbal"_n, rex_balance > rex_balance_table;
    ...
    */
   struct [[picoio::table,picoio::contract("pico.system")]] rex_loan {
      uint8_t             version = 0;
      name                from;
      name                receiver;
      asset               payment;
    ...
    */
   typedef picoio::multi_index< "cpuloan"_n, rex_loan,
    ...
    */
   typedef picoio::multi_index< "netloan"_n, rex_loan,
                               indexed_by<"byexpr"_n,  const_mem_fun<rex_loan, uint64_t, &rex_loan::by_expr>>,
                               indexed_by<"byowner"_n, const_mem_fun<rex_loan, uint64_t, &rex_loan::by_owner>>
                             > rex_net_loan_table;

   struct [[picoio::table,picoio::contract("pico.system")]] rex_order {
      uint8_t             version = 0;
      name                owner;
      asset               rex_requested;
      asset               proceeds;
      asset               stake_change;
      picoio::time_point   order_time;
      bool                is_open = true;
    ...
    */
   typedef picoio::multi_index< "rexqueue"_n, rex_order,
   ...
   /**
    * The PICOIO system contract.
    *
    * @details The PICOIO system contract governs ram market, voters, producers, global state.
    */
   class [[picoio::contract("pico.system")]] system_contract : public native {
      ...
      private:
         ...
         global_pico_state_singleton _globalpico;
         picoio_global_state      _gstate;
         picoio_global_state2     _gstate2;
         picoio_global_state3     _gstate3;
         picoio_global_state4     _gstate4;
         picoio_global_pico_state  _gpicostate;
      ...
      public:
         static constexpr picoio::name active_permission{"active"_n};
         static constexpr picoio::name token_account{"pico.token"_n};
         static constexpr picoio::name ram_account{"pico.ram"_n};
         static constexpr picoio::name ramfee_account{"pico.ramfee"_n};
         static constexpr picoio::name stake_account{"pico.stake"_n};
         static constexpr picoio::name swap_account{"pico.swap"_n};
         static constexpr picoio::name utils_account{"pico.utils"_n};
         static constexpr picoio::name bpay_account{"pico.bpay"_n};
         static constexpr picoio::name spay_account{"pico.spay"_n};
         static constexpr picoio::name vpay_account{"pico.vpay"_n};
         static constexpr picoio::name oracle_account{"pico.oracle"_n};
         static constexpr picoio::name names_account{"pico.names"_n};
         static constexpr picoio::name saving_account{"pico.saving"_n};
         static constexpr picoio::name rex_account{"pico.rex"_n};
         static constexpr picoio::name null_account{"pico.null"_n};
         static constexpr picoio::name pico_usd_pair{"pico.usd"_n};
          ...
          * @param ds   - The contract data represented as an `picoio::datastream`.
          */
          ...
          */
         static symbol get_core_symbol( name system_account = "pico"_n ) {
       ...
       void setgiftattr( name value );
          ...
          */
         [[picoio::action]]
         void activate( const picoio::checksum256& feature_digest );
          ...
          *
          * @pre A voting requipicoent must be satisfied before action can be executed.
          ...
          * is refunded any picoaining balance.
          ...
          */
         [[picoio::action]]
         void regproducer2( const name& producer, const picoio::block_signing_authority& producer_authority, const std::string& url, uint16_t location );
          ...
          * @pre Voter must have previously staked some PICO for voting
          * @pre Voter->staked must be up to date
          *
          * @post Every producer previously voted for will have vote reduced by previous vote weight
          * @post Every producer newly voted for will have vote increased by new vote amount
          * @post Prior proxy will proxied_vote_weight decpicoented by previous vote weight
          * @post New proxy will proxied_vote_weight incpicoented by new vote weight
          */
         [[picoio::action]]
          ...
          */
         [[picoio::action]]
         void setparams( const picoio::blockchain_parameters& params );
          ...
          * To rewards action.
          *
          * @details Transfer to per_block, per_vote and pico savings accounts.
          * @param payer - payer.
          * @param amount - amount of tokens to transfer to per_block, per_vote and pico savings accounts.
          */
         [[picoio::action]]
          ...
          * @param revision - it has to be incpicoented by 1 compared with current revision.
          *
          ...
          *     The picoaining inflation will be sent to the `picoio.saving` account.
          ...
          *     The picoaining rewards will be distributed proportional to votes received.
         ...
         using init_action = picoio::action_wrapper<"init"_n, &system_contract::init>;
         using newaccount_action = picoio::action_wrapper<"newaccount"_n, &system_contract::newaccount>;
         using activate_action = picoio::action_wrapper<"activate"_n, &system_contract::activate>;
         using delegatebw_action = picoio::action_wrapper<"delegatebw"_n, &system_contract::delegatebw>;
         using deposit_action = picoio::action_wrapper<"deposit"_n, &system_contract::deposit>;
         using withdraw_action = picoio::action_wrapper<"withdraw"_n, &system_contract::withdraw>;
         using buyrex_action = picoio::action_wrapper<"buyrex"_n, &system_contract::buyrex>;
         using unstaketorex_action = picoio::action_wrapper<"unstaketorex"_n, &system_contract::unstaketorex>;
         using sellrex_action = picoio::action_wrapper<"sellrex"_n, &system_contract::sellrex>;
         using cnclrexorder_action = picoio::action_wrapper<"cnclrexorder"_n, &system_contract::cnclrexorder>;
         using rentcpu_action = picoio::action_wrapper<"rentcpu"_n, &system_contract::rentcpu>;
         using rentnet_action = picoio::action_wrapper<"rentnet"_n, &system_contract::rentnet>;
         using fundcpuloan_action = picoio::action_wrapper<"fundcpuloan"_n, &system_contract::fundcpuloan>;
         using fundnetloan_action = picoio::action_wrapper<"fundnetloan"_n, &system_contract::fundnetloan>;
         using defcpuloan_action = picoio::action_wrapper<"defcpuloan"_n, &system_contract::defcpuloan>;
         using defnetloan_action = picoio::action_wrapper<"defnetloan"_n, &system_contract::defnetloan>;
         using updaterex_action = picoio::action_wrapper<"updaterex"_n, &system_contract::updaterex>;
         using rexexec_action = picoio::action_wrapper<"rexexec"_n, &system_contract::rexexec>;
         using setrex_action = picoio::action_wrapper<"setrex"_n, &system_contract::setrex>;
         using mvtosavings_action = picoio::action_wrapper<"mvtosavings"_n, &system_contract::mvtosavings>;
         using mvfrsavings_action = picoio::action_wrapper<"mvfrsavings"_n, &system_contract::mvfrsavings>;
         using consolidate_action = picoio::action_wrapper<"consolidate"_n, &system_contract::consolidate>;
         using closerex_action = picoio::action_wrapper<"closerex"_n, &system_contract::closerex>;
         using undelegatebw_action = picoio::action_wrapper<"undelegatebw"_n, &system_contract::undelegatebw>;
         using refund_action = picoio::action_wrapper<"refund"_n, &system_contract::refund>;
         using refundtostake_action = picoio::action_wrapper<"refundtostake"_n, &system_contract::refundtostake>;
         using regproducer_action = picoio::action_wrapper<"regproducer"_n, &system_contract::regproducer>;
         using regproducer2_action = picoio::action_wrapper<"regproducer2"_n, &system_contract::regproducer2>;
         using unregprod_action = picoio::action_wrapper<"unregprod"_n, &system_contract::unregprod>;
         using setram_action = picoio::action_wrapper<"setram"_n, &system_contract::setram>;
         using setmin_account_stake_action = picoio::action_wrapper<"setminstake"_n, &system_contract::setminstake>;
         using setramrate_action = picoio::action_wrapper<"setramrate"_n, &system_contract::setramrate>;
         using voteproducer_action = picoio::action_wrapper<"voteproducer"_n, &system_contract::voteproducer>;
         using regproxy_action = picoio::action_wrapper<"regproxy"_n, &system_contract::regproxy>;
         using claimrewards_action = picoio::action_wrapper<"claimrewards"_n, &system_contract::claimrewards>;
         using torewards_action = picoio::action_wrapper<"torewards"_n, &system_contract::torewards>;

         using rmvproducer_action = picoio::action_wrapper<"rmvproducer"_n, &system_contract::rmvproducer>;
         using updtrevision_action = picoio::action_wrapper<"updtrevision"_n, &system_contract::updtrevision>;
         using bidname_action = picoio::action_wrapper<"bidname"_n, &system_contract::bidname>;
         using bidrefund_action = picoio::action_wrapper<"bidrefund"_n, &system_contract::bidrefund>;
         using setpriv_action = picoio::action_wrapper<"setpriv"_n, &system_contract::setpriv>;
         using setalimits_action = picoio::action_wrapper<"setalimits"_n, &system_contract::setalimits>;
         using setparams_action = picoio::action_wrapper<"setparams"_n, &system_contract::setparams>;
         using setrwrdratio_action = picoio::action_wrapper<"setrwrdratio"_n, &system_contract::setrwrdratio>;
         using setlockperiod_action = picoio::action_wrapper<"setlockperiod"_n, &system_contract::setlockperiod>;
         using setunloperiod_action = picoio::action_wrapper<"setunloperiod"_n, &system_contract::setunloperiod>;

         using setgiftcontra_action = picoio::action_wrapper<"setgiftcontra"_n, &system_contract::setgiftcontra>;
         using setgiftiss_action    = picoio::action_wrapper<"setgiftiss"_n,    &system_contract::setgiftiss>;
         using setgiftattr_action   = picoio::action_wrapper<"setgiftattr"_n,   &system_contract::setgiftattr>;
         using setinflation_action = picoio::action_wrapper<"setinflation"_n, &system_contract::setinflation>;

      private:
         // Implementation details:

         // defined in pico.system.cpp
         static picoio_global_state get_default_parameters();
         static picoio_global_state4 get_default_inflation_parameters();
         static picoio_global_pico_state get_default_pico_parameters();
         ...
         void check_voting_requipicoent( const name& owner,
         ...
         void picoove_loan_from_rex_pool( const rex_loan& loan );
         ...
         picoio::block_signing_authority convert_to_block_signing_authority( const picoio::public_key& producer_key );
         void register_producer( const name& producer, const picoio::block_signing_authority& producer_authority, const std::string& url, uint16_t location );
         ...
         // defined in pico.system.cpp
         // to keep Guardian status, account should reassert its vote every picoio_global_pico_state::reassertion_period
         bool vote_is_reasserted( picoio::time_point last_reassertion_time ) const;

         // calculates amount of free bytes for current stake
         int64_t ram_gift_bytes( int64_t stake ) const;

         //defined in rotation.cpp
         std::vector<picoio::producer_authority> get_rotated_schedule();
   ...
   /** @}*/ // end of @defgroup picoiosystem pico.system
} /// picoiosystem
