 ...
 * PICOIO Contracts
 *
 * @details The design of the PICOIO blockchain calls for a number of smart contracts that are run at a
 ...
 * managing, and/or using an PICOIO blockchain. They are provided for reference purposes:
 * - pico.bios
 * - pico.system
 * - pico.msig
 * - pico.wrap
...
namespace picoiobios {
   ...
   /**
    * @defgroup picoiobios pico.bios
    * @ingroup picoiocontracts
    *
    * pico.bios is a minimalistic system contract that only supplies the actions that are absolutely
    * critical to bootstrap a chain and nothing more.
    *
    * @{
    */
   class [[picoio::contract("pico.bios")]] bios : public picoio::contract {
      public:
          ...
          */
         [[picoio::action]]
         void setprods( const std::vector<picoio::producer_authority>& schedule );
          ...
          */
         [[picoio::action]]
         void reqactivated( const picoio::checksum256& feature_digest );
          ...
          */
         typedef picoio::multi_index< "abihash"_n, abi_hash > abi_hash_table;
   ...
   /** @}*/ // end of @defgroup picoiobios pico.bios
} /// namespace picoiobios
