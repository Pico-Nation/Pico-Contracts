...
namespace picoio {
   ...
   /**
    * @defgroup picoioauth pico.auth
    * @ingroup picoiocontracts
    *
    * pico.auth contract
    *
    * @details pico.auth contract defines the structures and actions that allow users and contracts to add, store, revoke
    * public keys.
    * @{
    */
   class [[picoio::contract("pico.auth")]] auth : public attribute {
   public:
       ...
       *
       * @details buy AUTH credit at a current REM-USD price indicated in the pico.orace contract.
       *
   ...
   private:
      ...
      PICOLIB_SERIALIZE( authkeys, (key)(owner)(pub_key)(extra_pub_key)(not_valid_before)(not_valid_after)(revoked_at))
      };
   ...
   /** @}*/ // end of @defgroup picoioauth pico.auth
} /// namespace picoio
